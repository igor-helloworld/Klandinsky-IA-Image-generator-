...
class Text2ImageAPI:
    ...
    def save_image(self, images, file_path):
...
if __name__ == '__main__':
    api = Text2ImageAPI('https://api-key.fusionbrain.ai/', 'C6ACC3999A43A0E0F6A097AFDCF154DD', '901BC4402ECD96296F1922D6718829D2')
    model_id = api.get_model()
    uuid = api.generate("гигантский оранжевый и блестящий кабачок размером в два километра который стоит рядом с Бурж Халиф и его кушает большая гусиница и все в огне", model_id)
